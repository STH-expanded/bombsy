class Display {
    constructor(game) {
        ...
        this.centerPokemonSprite = document.createElement("img");
        this.centerPokemonSprite.src = "./centerpokemon.png";
        this.game = game;
        ...
        this.update = () => {
            ...
            this.game.obstacles.forEach(obstacle => {
                this.cx.fillRect(obstacle.pos.x * this.zoom, obstacle.pos.y * this.zoom, obstacle.size.x * this.zoom, obstacle.size.y * this.zoom);
            });
            //player
            ...
            var centerPokemonSprite = this.centerPokemonSprite;
            // joueur 1 image :
            this.cx.drawImage(sprite, 0, 0, 117, 83, player.pos.x * this.zoom, player.pos.y * this.zoom, player.size.x * this.zoom, player.size.y * this.zoom);
            this.cx.drawImage(centerPokemonSprite, 0, 0, 180, 180, 266 * this.zoom, 116 * this.zoom, 80 * this.zoom, 80 * this.zoom);
            ...
            this.cx.fillText("x:" + player.pos.x + " y:" + player.pos.y, 8 * this.zoom, 16 * this.zoom);
            this.cx.fillText("x:" + player2.pos.x + " y:" + player2.pos.y, 392 * this.zoom, 16 * this.zoom);
            this.frame++;
        };
        this.resize = () => {
