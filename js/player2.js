class Player2 {
    constructor(pos, size) {
        ...
        this.moveX = game => {
            if (game.keys.get('arrow-left')) this.speed.x = -this.walkSpeed;
            else if (game.keys.get('arrow-right')) this.speed.x = this.walkSpeed;
            else this.speed.x = 0;
        ...
        this.moveY = game => {
            ...
            if (floor.length > 0 && game.keys.get('arrow-up')) this.speed.y = -this.jumpSpeed;
